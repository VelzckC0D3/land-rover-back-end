...
class Api::V1::ReservationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_reservation" do
    assert_difference("Api::V1::Reservation.count") do
      post api_v1_reservations_url, params: { api_v1_reservation: { car_id: @api_v1_reservation.car_id, city: @api_v1_reservation.city, date: @api_v1_reservation.date, user_id: @api_v1_reservation.user_id } }, as: :json
    end
  ...
  test "should update api_v1_reservation" do
    patch api_v1_reservation_url(@api_v1_reservation), params: { api_v1_reservation: { car_id: @api_v1_reservation.car_id, city: @api_v1_reservation.city, date: @api_v1_reservation.date, user_id: @api_v1_reservation.user_id } }, as: :json
    assert_response :success
  end
